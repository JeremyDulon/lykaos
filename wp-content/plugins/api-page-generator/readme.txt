...
Installing "api_page_generator" can be done either by searching for "api_page_generator" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
